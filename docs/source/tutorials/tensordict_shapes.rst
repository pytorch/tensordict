...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensordict['a']:
     tensor([[0.7617, 0.7845, 0.9631, 0.0334],
            [0.8414, 0.5737, 0.4006, 0.1356],
            [0.3061, 0.8221, 0.6795, 0.4787]])

    gathered_tensordict['a']:
     tensor([[0.9631, 0.7845, 0.7617, 0.7617],
            [0.4006, 0.8414, 0.8414, 0.4006],
            [0.3061, 0.4787, 0.8221, 0.4787]])
