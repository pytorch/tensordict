...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    (tensor([[0.5854, 0.0000, 0.0000, 0.2658]], grad_fn=<ReluBackward0>), tensor([[-0.4336, -0.8326,  0.6386,  0.3143]], grad_fn=<AddmmBackward0>), tensor([[-0.4336, -0.8326]], grad_fn=<SplitBackward0>), tensor([[1.4458, 1.2087]], grad_fn=<ClampMinBackward0>))
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Time for TDModule:  210.05 micro-seconds
    Time for exported module:  155.21 micro-seconds
 ...
 .. code-block:: none
    ...
    class GraphModule(torch.nn.Module):
        def forward(self, p_module_0_module_weight: "f32[4, 3]", p_module_0_module_bias: "f32[4]", p_module_2_module_weight: "f32[4, 4]", p_module_2_module_bias: "f32[4]", x: "f32[1, 3]"):
            # File: /Users/vmoens/repos/tensordict/.venv/lib/python3.12/site-packages/torch/nn/modules/linear.py:134 in forward, code: return F.linear(input, self.weight, self.bias)
            ...
            # File: /Users/vmoens/repos/tensordict/.venv/lib/python3.12/site-packages/torch/nn/modules/activation.py:143 in forward, code: return F.relu(input, inplace=self.inplace)
            ...
            # File: /Users/vmoens/repos/tensordict/tensordict/nn/distributions/continuous.py:85 in forward, code: loc, scale = tensor.chunk(2, -1)
            chunk = torch.ops.aten.chunk.default(linear_1, 2, -1)
            getitem: "f32[1, 2]" = chunk[0]
            getitem_1: "f32[1, 2]" = chunk[1];  chunk = None

            # File: /Users/vmoens/repos/tensordict/tensordict/nn/utils.py:70 in forward, code: return torch.nn.functional.softplus(x + self.bias) + self.min_val
            ...
            # File: /Users/vmoens/repos/tensordict/tensordict/nn/distributions/continuous.py:86 in forward, code: scale = self.scale_mapping(scale).clamp_min(self.scale_lb)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensor([[-0.4336, -0.8326]], grad_fn=<SplitBackward0>)
