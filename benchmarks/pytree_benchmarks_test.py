...
def test_reshape_pytree(benchmark, nested_dict):
    benchmark.pedantic(tree_map, args=(lambda x: x.reshape(12, *x.shape[2:]), nested_dict), iterations=10000)
...
def test_view_pytree(benchmark, nested_dict):
    benchmark.pedantic(tree_map, args=(lambda x: x.view(12, *x.shape[2:]), nested_dict), iterations=10000)
...
def test_unbind_pytree(benchmark, nested_dict):
    benchmark.pedantic(tree_map, args=(lambda x: x.unbind(0), nested_dict), iterations=10000)
...
def test_split_pytree(benchmark, nested_dict):
    benchmark.pedantic(tree_map, args=(lambda x: x.split([1, 2], 0), nested_dict), iterations=10000)
