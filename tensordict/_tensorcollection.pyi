...
class TensorCollection:
    ...
    def clamp_min_(self, other: TensorCollection | torch.Tensor) -> T: ...
    def clamp_min(
        self,
        other: TensorCollection | torch.Tensor,
        default: str | CompatibleType | None = None,
    ) -> T: ...
    def pow_(self, other: TensorCollection | torch.Tensor) -> T: ...
    def pow(
        self,
        other: TensorCollection | torch.Tensor,
        *,
    ...
    def div_(self, other: TensorCollection | torch.Tensor) -> T: ...
    def div(
        self,
        other: TensorCollection | torch.Tensor,
        *,
