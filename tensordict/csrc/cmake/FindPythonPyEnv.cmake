...
if (NOT DEFINED PYTHON_EXECUTABLE)
  # Try to find Python executable, with special handling for Apple Silicon
  if(CMAKE_SYSTEM_PROCESSOR MATCHES "arm64" OR CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64")
    # On Apple Silicon, try python3 first
    execute_process(
...
# Log architecture information for debugging
if(CMAKE_SYSTEM_PROCESSOR MATCHES "arm64" OR CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64")
  debug_message("Detected Apple Silicon (ARM64) architecture")
endif()
