# -*- coding: utf-8 -*-
"""tensordict-datasets.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YnzyPma8Xw1KWok4lhMibk_zIomp4MP3

# Using TensorDict for datasets

In this tutorial we demonstrate how `TensorDict` can be used to efficiently and transparently load and manage data inside a training pipeline. The tutorial is based heavily on the [PyTorch Quickstart Tutorial](https://pytorch.org/tutorials/beginner/basics/quickstart_tutorial.html), but modified to demonstrate use of `TensorDict`.
"""
